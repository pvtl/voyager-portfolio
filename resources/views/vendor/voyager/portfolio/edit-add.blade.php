...
@section('content')
    <div class="page-content container-fluid">
        <form class="form-edit-add" role="form" action="@if(isset($dataTypeContent->id)){{ route('voyager.portfolio.update', $dataTypeContent->id) }}@else{{ route('voyager.portfolio.store') }}@endif" method="POST" enctype="multipart/form-data">
            @php
                ...
                <div class="col-md-8">
                    ...
                    <div class="panel">
                        ...
                        <div class="panel-body">
                            @php $include = ['title']; @endphp
                            @include('voyager::portfolio.fields')
                        </div>
                    </div>
                    ...
                    <div class="panel">
                        ...
                        <div class="panel-body">
                            @php $include = ['body', 'excerpt', 'testimonial', 'testimonial_author']; @endphp
                            @include('voyager::portfolio.fields')
                        </div>
                    </div>
                ...
                <div class="col-md-4">
                    ...
                    <div class="panel panel panel-bordered panel-warning">
                        ...
                        <div class="panel-body">
                            ...
                            @php $include = ['status', 'category_id', 'featured']; @endphp
                            @include('voyager::portfolio.fields')
                        </div>
                    </div>
                    ...
                    <div class="panel panel-bordered panel-info">
                        ...
                        <div class="panel-body">
                            @php $include = ['meta_title', 'meta_description']; @endphp
                            @include('voyager::portfolio.fields')
                        </div>
                    </div>
                </div>
